...
It is also possible to collect and store ``/export/`` data of Galaxy instances inside Docker in a dedicated [Data volume container](https://docs.docker.com/engine/userguide/dockervolumes/ easily created with:
